                      ...
                      <li key={j.id} className="">
                        <div className="rounded-md border border-slate-200 bg-white p-3 shadow-sm">
                          <div className="mb-2 flex items-center justify-between">
                            ...
                            <span className="inline-flex items-center rounded-full bg-slate-100 px-2 py-0.5 text-[11px] font-medium text-slate-700">Job</span>
                          </div>
                          <div className="grid grid-cols-1 gap-2 md:grid-cols-3">
                            ...
                            <div className="flex items-end justify-end gap-2">
                              <button
                                ...
                                className="inline-flex items-center gap-1.5 rounded-md border border-red-600 bg-white px-3 py-1.5 text-xs font-medium text-red-700 shadow-sm hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                              >
                                Delete
                              </button>
                              <button
                                ...
                                className="inline-flex items-center gap-1.5 rounded-md bg-indigo-600 px-3 py-1.5 text-xs font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                              >
                                Save
                              </button>
                            </div>
