...
1. Specify 1-3 pain triggers as the attribute that must scale for this pain to become intolerable in the format of:
...
2. For each pain trigger include:
    - A list of 3-5 Ideal Customer Profile (ICP) organization archetypes most likely to experience these pain triggers as:
    ...
    - A list of 3-5 external events (ZMOTs) that likely caused or accelerated these internal conditions in these organizations as:
        ...
        - observable_moment: Specific externally observable data points that indicate the event such as News article, press release, social media post, job posting, etc.
